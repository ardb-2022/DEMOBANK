...
export class TransTransactionComponent implements OnInit {
  ...
  save() {
    ...
    else if (parseFloat(this.TrfTotAmt.toFixed(2)) != parseFloat(this.CrTrfTotAmt.toFixed(2))) {
      console.log(parseFloat(this.TrfTotAmt.toFixed(2)),parseFloat(this.CrTrfTotAmt.toFixed(2)));
  ...
  private sumTransfer(): void {
    ...
    this.td_deftranstrfList.forEach(e => {
      ...
      this.TrfTotAmt = parseFloat(this.TrfTotAmt.toFixed(2));
    });
  ...
  private CrsumTransfer(): void {
    ...
    this.CrTrfTotAmt = parseFloat(this.CrTrfTotAmt.toFixed(2))
