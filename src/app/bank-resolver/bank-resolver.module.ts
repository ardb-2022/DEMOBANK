...
@NgModule({
  declarations: [  AbsPipe,
    ...
    LoanSubCashBookComponent, AccOpeningViewComponent, NeftOutwardComponent,PrintShareCertificateComponent,
    ...
    BakdatevoucherComponent, LoanScheduleComponent, YearcloseComponent,
          ...
          ConsoCashAccNewComponent, LoanDisbCertificateComponent, CloseAccDtlsComponent, GMloanDCComponent, RecovVillageComponent,
           UserWiseTransactionComponent, UserWiseTransactionLoanComponent, GmLoanSubsidyComponent, LoanDisburseActWiseComponent,
            ...
            DetailListSbcaConstWiseComponent, FortnightlyReturnComponent, ConsoFortnightlyReturnComponent, BorrowingComponent, DcbrVillWiseComponent, 
             GoldTestAndValuationReportComponent, DemandNoticeContaiComponent, UcicMergeComponent, CTloanDCComponent, 
            ...
            DcbrGroupWiseComponent, TamlukComponent, TamlukFastPageComponent, EmiCalculatorComponent, RecovSummaryComponent, RiskFundComponent, BankuraComponent, 
            BankuraFastPageComponent, SendSmsFromDemandComponent, UpdatedDemandListComponent, CtFortnightNewComponent, CtFortnightNewConsoComponent, LoanDisburseSummaryComponent,
             ...
             ConsoGenLedgerComponent, InterestSubsidySHGComponent, AgentMasterComponent,CashAtBankPositionComponent,AgentCollectionPostingComponent,UserTransactionComponent,
             GoldItemMasterComponent, GoldRateMasterComponent, GoldSafeMasterComponent, GoldLoanMasterComponent,DenominationPositionComponent, 
             PayrollPostingComponent,AssetsManagementComponent,CalDepPostComponent,ScrollBookDenoComponent,ChequebookIssueComponent,ICICVenderListComponent
             ,DetailListIntroducerComponent,AgentCollSummaryComponent,CertStatusUpdateComponent,BranchWiseCashcumtrialComponent,BranchWiseProfitAndLossComponent,
             AgentWiseLoanCollComponent,AgentDepositDetailsSumComponent,QueryWithLedgerComponent,TransBulkImportComponent,ProfitLossDateRangeComponent,
             ProfitLossDateRangeConsoComponent,DcbSummaryComponent,DcbSummaryBranchWiseComponent,DLGLSummary,ConsoDtlLstAllComponent,
             GoldLoanOpeningRepComponent,GenDemandLetterComponent,DetaillistAllConsoComponent,ConsolidatedInterestPaybleComponent
  ],  
  imports: [
    MatAutocompleteModule, MatProgressBarModule, MatBadgeModule,NgxChartsModule,
