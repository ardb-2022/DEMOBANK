...
displayedColumns: string[] = ['trans_dt','brn_cd','trans_cd', 'receive_type', 'bank_cr_acc_no', 'bank_cr_acc_name','amount','payment_ref_no','sender_name','sender_acc_no','sender_ifsc_code','status'];
    ...
    this.svc.addUpdDel('Deposit/NeftInward',dt).subscribe(data=>{console.log(data)
      ...
      if(!this.reportData){
       ...
       this.reportData.forEach(e=>{
        e.trans_dt=this.comSer.getFormatedDate(e.trans_dt);
        this.clrSum+=e.amount;
...
downloadexcel(){
  ...
  this.exportAsService.save(this.exportAsConfig, 'NEFTIN').subscribe(() => {
    // save started
    console.log("hello")
  });
}
