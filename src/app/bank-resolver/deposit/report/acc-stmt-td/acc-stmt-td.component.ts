...
export class AccStmtTDComponent implements OnInit,AfterViewInit {
  ...
  // displayedColumns: string[] = ['acc_num','intt_trf_type', 'trans_type','trans_dt','prn_amt'];
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.reportData.forEach(e=>{
        ...
        if (e.trans_mode === 'O' && e.trans_type === 'D') {
          e.transactionMeaning = '(Open and Credit)';
        } else if (e.trans_mode === 'R' && e.trans_type === 'D') {
          e.transactionMeaning = '(Renew and Credit)';
        } else if (e.trans_mode === 'C' && e.trans_type === 'W') {
          e.transactionMeaning = '(Close and Debit)';
        } else {
          e.transactionMeaning = 'Other';
        }
