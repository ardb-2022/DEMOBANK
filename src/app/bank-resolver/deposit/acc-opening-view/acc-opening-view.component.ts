  ...
  validateData() {
    ...
    for (const l in this.td_signatoryList) {
     ...
     for (const l in this.td_introducerlist) {
      if (this.td_introducerlist[l].introducer_name == null || this.td_introducerlist[l].introducer_name == undefined|| this.td_introducerlist[l].introducer_name == '') {
      this.td_introducerlist[l].acc_num = this.tm_deposit.acc_num;
      this.td_introducerlist[l].brn_cd = this.branchCode;
      this.td_introducerlist[l].acc_type_cd = Number(this.tm_deposit.acc_type_cd);
      this.td_introducerlist[l].upd_ins_flag = 'D';
      ...
      this.td_introducerlist[l].brn_cd = this.branchCode;
      this.td_introducerlist[l].acc_type_cd = Number(this.tm_deposit.acc_type_cd);
      this.td_introducerlist[l].upd_ins_flag = 'U';
...
setAgent(){
  ...
  removeIntroducer(i) {
      this.td_introducerlist[i].upd_ins_flag='D';
      this.td_introducerlist[i].introducer_name='';
      this.td_introducerlist[i].introducer_acc_num='';
      this.td_introducerlist[i].introducer_acc_type=1;
    ...
    this.svc.addUpdDel<any>('UCIC/GetCustomerDtls', temp_mm_cust).subscribe(
      res => {
        ...
        if (temp_mm_cust_list !== undefined && temp_mm_cust_list != null && temp_mm_cust_list.length > 0) {
          ...
          this.td_introducerlist[idx].introducer_name = temp_mm_cust.cust_name;
          this.td_introducerlist[idx].brn_cd = temp_mm_cust.brn_cd;
          this.td_introducerlist[idx].acc_num= this.tm_deposit.acc_num;
          this.td_introducerlist[idx].acc_type_cd= this.tm_deposit.acc_type_cd;
        }
        this.isLoading = false;
      },
      err => { this.isLoading = false; }
