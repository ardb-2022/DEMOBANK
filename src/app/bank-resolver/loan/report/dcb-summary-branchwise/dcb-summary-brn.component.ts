...
@Component({
  selector: 'app-dcb-summary-brn',
  templateUrl: './dcb-summary-brn.component.html',
  styleUrls: ['./dcb-summary-brn.component.css'],
  providers:[ExportAsService]
})
export class DcbSummaryBranchWiseComponent implements OnInit {
