  ...
  public onApproveClick(): void {
    ...
    if (this.selectedVm.loan.tddeftrans.trans_type === 'R') {
      if(this.selectedVm.loan.tddeftrans.paid_to=='YEAREND'){
        ...
        this.svc.addUpdDel<any>(this.selectedVm.loan.tmloanall.emi_formula_no==1?'Loan/CalculateLoanInterest':'Loan/CalculateLoanInterest', this.selectedVm.loan.tmloanall.emi_formula_no==1?dxEMI:param).subscribe(
          loanRes => {
            this.isLoading = false;
