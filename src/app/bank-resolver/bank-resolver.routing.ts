...
import { LoanScheduleComponent } from './loan/masters/loanSchedule/loan-schedule.component';
...
import { ConsoBalSheetComponent } from './finance/report/branchWise-bal-sheet/conso-bal-sheet.component';
...
import { EmiCalculatorComponent } from './loan/masters/emi-calculator/emi-calculator.component';
...
import { DenominationPositionComponent } from './master/denomination-position/denomination-position.component';
...
import { PayrollPostingComponent } from './finance/payroll-posting/payroll-posting.component';
...
import { PrintShareCertificateComponent } from './deposit/report/print-share-certificate/print-share-certificate.component';
import { CashAtBankPositionComponent } from './finance/report/cash-at-bank-position/cash-at-bank-position.component';
import { ScrollBookDenoComponent } from './finance/report/scroll-book-denominaion/scroll-book-denominaion.component';
import { UserTransactionComponent } from './deposit/report/user-transaction/user-transaction.component';
import { ChequebookIssueComponent } from './deposit/chequebook/chequebook-issue/chequebook-issue.component';
import { ICICVenderListComponent } from './deposit/report/icic-vender-list/icic-vender-list.component';
import { DetailListIntroducerComponent } from './deposit/report/detail-list-introducer/detail-list-introducer.component';
import { AgentCollSummaryComponent } from './deposit/agent-coll-summary/agent-coll-summary.component';
import { CertStatusUpdateComponent } from './deposit/masters/cert-status-update/cert-status-update.component';
import { BranchWiseCashcumtrialComponent } from './finance/report/branch-wise-cashcumtrial/branch-wise-cashcumtrial.component';
import { BranchWiseProfitAndLossComponent } from './finance/report/branch-wise-profit-and-loss/branch-wise-profit-and-loss.component';
// import { AgentWiseLoanCollComponent } from './loan/report/agent-wise-loan-coll/agent-wise-loan-coll.component';
import { AgentWiseLoanCollComponent } from './loan/report/agent-wise-loan-coll/agent-wise-loan-coll.component';

import { AgentDepositDetailsSumComponent } from './deposit/agent-deposit-details-sum/agent-deposit-details-sum.component';
import { QueryWithLedgerComponent } from './loan/transaction/query-with-ledger/query-with-ledger.component';
import { TransBulkImportComponent } from './transfer/trans-bulk-import/trans-bulk-import.component';
import { ProfitLossDateRangeComponent } from './finance/report/profit-loss-date-range/profit-loss-date-range.component';
import { ProfitLossDateRangeConsoComponent } from './finance/report/profit-loss-date-range-conso/profit-loss-date-range-consocomponent';
import { DcbSummaryComponent } from './loan/report/dcb-summary/dcb-summary.component';
import { DLGLSummary } from './finance/report/gldl-summary/gldl-summary.component';
import { DcbSummaryBranchWiseComponent } from './loan/report/dcb-summary-branchwise/dcb-summary-brn.component';
import { ConsoDtlLstAllComponent } from './deposit/report/conso-dtl-lst-all/conso-dtl-lst-all.component';
import { GoldLoanOpeningRepComponent } from './loan/report/gold-loan-opening-rep/gold-loan-opening-rep.component';
import { GenDemandLetterComponent } from './loan/report/gen-demand-letter/gen-demand-letter.component';
import { DetaillistAllConsoComponent } from './loan/report/detaillist-all-conso/detaillist-all-conso.component';
import { ConsolidatedInterestPaybleComponent } from './finance/report/consolidated-interest-payble/consolidated-interest-payble.component';
...
const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'FT_PAYROLL_POST', component: PayrollPostingComponent },
      ...
      { path: 'DR_DL_ALL_CONSO', component: ConsoDtlLstAllComponent, canActivate: [AuthGuard] },
      ...
      { path: 'FR_CCTrialBW', component: BranchWiseCashcumtrialComponent, canActivate: [AuthGuard] },
      ...
      { path: 'FR_BWBalanceSheet', component: ConsoBalSheetComponent, canActivate: [AuthGuard] },
      { path: 'FR_CdCashAccNew', component: ConsoCashAccNewComponent, canActivate: [AuthGuard] },
      { path: 'FR_cashAtBank', component: CashAtBankPositionComponent, canActivate: [AuthGuard] },
      { path: 'FR_scrollDeno', component: ScrollBookDenoComponent, canActivate: [AuthGuard] },
      { path: 'DM_Agent', component: AgentMasterComponent, canActivate: [AuthGuard] },
      { path: 'DR_Print_SH_CERT', component: PrintShareCertificateComponent, canActivate: [AuthGuard] },
      { path: 'LM_L_COL_AG', component: AgentWiseLoanCollComponent, canActivate: [AuthGuard] },
      
      { path: 'LR_Demand_Letter', component: GenDemandLetterComponent, canActivate: [AuthGuard] },
      ...
      { path: 'FR_GL_DL_SUM', component: DLGLSummary, canActivate: [AuthGuard] },
      ...
      { path: 'LT_OpenLoanAccNew', component: OpenLoanAccountComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LM_LoanSchedule', component: LoanScheduleComponent, canActivate: [AuthGuard] },
      ...
      { path: 'DR_DL_INTRO', component: DetailListIntroducerComponent, canActivate: [AuthGuard] },
      ...
      { path: 'DM_Cert_Update', component: CertStatusUpdateComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LR_PuLoanStmt', component: BMLoanStatementComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LR_DlistAll_Conso', component: DetaillistAllConsoComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LR_stmt', component: AdRecStmtComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LM_EMI_Cal', component: EmiCalculatorComponent, canActivate: [AuthGuard] },
      ...
      { path: 'LT_DCB_SUM', component: DcbSummaryComponent, canActivate: [AuthGuard] },
      { path: 'LT_DCB_SUM_BRN', component: DcbSummaryBranchWiseComponent, canActivate: [AuthGuard] },
      { path: 'LT_DCB', component: NpaSummaryComponent, canActivate: [AuthGuard] },
      ...
      { path: 'DT_AgentCom', component: AgentCommissionComponent, canActivate: [AuthGuard] },
      { path: 'DT_AgentCollSum', component: AgentCollSummaryComponent, canActivate: [AuthGuard] },
      { path: 'DR_DDS_DEP_REP', component: AgentDepositDetailsSumComponent, canActivate: [AuthGuard] },
      ...
      { path: 'FR_PLDateRange', component: ProfitLossDateRangeComponent, canActivate: [AuthGuard] },
      { path: 'FR_PLDateRangeConso', component: ProfitLossDateRangeConsoComponent, canActivate: [AuthGuard] },
      { path: 'FR_PL_New', component: ProfitAndLossNewComponent, canActivate: [AuthGuard] },
      { path: 'FR_PL_New_BW', component: BranchWiseProfitAndLossComponent, canActivate: [AuthGuard] },
      ...
      { path: 'FR_ConsoInttPay', component: ConsolidatedInterestPaybleComponent, canActivate: [AuthGuard] },
      ...
      { path: 'MR_deno_status', component: TradingAccComponent, canActivate: [AuthGuard] },
      ...
      { path: 'MR_deno_position', component: DenominationPositionComponent, canActivate: [AuthGuard] },
      { path: 'DT_User_trans', component: UserTransactionComponent, canActivate: [AuthGuard] },
      { path: 'DT_CheqIssue', component: ChequebookIssueComponent, canActivate: [AuthGuard] },
      { path: 'DT_ICICI_Ven_Lst', component: ICICVenderListComponent, canActivate: [AuthGuard] },
      { path: 'LT_Query', component: QueryWithLedgerComponent, canActivate: [AuthGuard] },
      { path: 'TT_TransBulkEntry', component: TransBulkImportComponent, canActivate: [AuthGuard] },
