...
@Component({
  selector: 'app-branch-wise-cashcumtrial',
  templateUrl: './branch-wise-cashcumtrial.component.html',
  styleUrls: ['./branch-wise-cashcumtrial.component.css'],
  providers:[ExportAsService]

})
export class BranchWiseCashcumtrialComponent implements OnInit,AfterViewInit {
