...
@Component({
  selector: 'app-profit-loss-date-range',
  templateUrl: './profit-loss-date-range.component.html',
  styleUrls: ['./profit-loss-date-range.component.css'],
  providers:[ExportAsService]
})
export class ProfitLossDateRangeComponent implements OnInit {
