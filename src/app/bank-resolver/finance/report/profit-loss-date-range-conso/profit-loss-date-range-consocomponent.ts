...
@Component({
  selector: 'app-profit-loss-date-range-conso',
  templateUrl: './profit-loss-date-range-conso.component.html',
  styleUrls: ['./profit-loss-date-range-conso.component.css'],
  providers:[ExportAsService]
})
export class ProfitLossDateRangeConsoComponent implements OnInit {
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      this.svc.addUpdDel('Finance/PopulatePLDateRangeConso',dt).subscribe(data=>{console.log(data)
