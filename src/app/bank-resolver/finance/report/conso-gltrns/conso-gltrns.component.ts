...
exportExcel(): void {
  ...
  const header = [
    { brn_cd: 'Branch Name', voucher_id: 'Voucher ID', voucher_dt: 'Voucher Date', narration: 'Narration', opp_gl: 'Opp GL', dr_amt: 'Debit Amount', cr_amt: 'Credit Amount', cum_bal: 'Cumulative Balance' }
  ];
  ...
  XLSX.utils.book_append_sheet(wb, ws, 'GLTransConso');

  // Step 5: Save to Excel file
  const fileName = 'GLTransConso.xlsx';
