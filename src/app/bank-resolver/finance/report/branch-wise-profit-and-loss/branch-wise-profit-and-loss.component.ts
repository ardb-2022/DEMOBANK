...
@Component({
  selector: 'app-branch-wise-profit-and-loss',
  templateUrl: './branch-wise-profit-and-loss.component.html',
  styleUrls: ['./branch-wise-profit-and-loss.component.css'],
  providers:[ExportAsService]

})
export class BranchWiseProfitAndLossComponent implements OnInit {
...
private GetBranchMaster() {
  ...
  setBranch(i:any){
    ...
    {
      this.selectedBranch=''
      this.selectedBranch=this.brnDtls.filter(e=>e.brn_cd==i)[0]?.brn_name
    }
  ...
  public SubmitReport() {
    if (this.reportcriteria.invalid) {
      ...
      //   "brn_cd": this.reportcriteria.value['branch'],
      ...
      this.svc.addUpdDel('Finance/PopulatePLDateRange',dt).subscribe(data=>{console.log(data)
  ...
  downloadexcel(){
    ...
    this.exportAsService.save(this.exportAsConfig, 'BranchWise_PL').subscribe(() => {
      // save started
      console.log("hello")
    });
  }
